...
import { IShop } from "interfaces"; // Remove UserCart import if not used elsewhere
import { UserCartDetails, CartType } from "interfaces/cart.interface";
  ...
  return (
    <div className={cls.wrapper}>
      <div className={cls.body}>
        {cart?.user_carts?.map((item: UserCartDetails) => (
            ...
            {item.cartDetails?.map((el) =>
              el.stock ? (
                <MemberCartProduct
                  ...
                  data={el} // Pass the entire CartStockWithProducts object
