...
const DEFAULT_LOCATION: MapLocation = {
  lat: -6.7924, // Dar es Salaam coordinates
  lng: 39.2083,
};

export default function AddressModal({ visible, handleCancel, editedAddress, ...rest }: Props) {
          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <TextInput
                ...
                value={formik.values.title || ''} // Provide empty string as fallback
